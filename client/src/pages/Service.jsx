    ...
    <section id="services" className="py-16 bg-gray-50">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
          {['Website Design', 'Web Development', 'Digital Marketing', 'Windows Homelication', 'Customized IT Solutions', 'Mobile App Development'].map((service, index) => (
            <div key={index} className="bg-white shadow-md rounded-lg p-6 transition-transform duration-300 transform hover:scale-105">
